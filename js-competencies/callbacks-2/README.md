...
## Directions
Fork this repo, clone your fork, then open callbacks-2.js and complete all the activities to make the spec runner pass it's tests (open the SpecRunner.html file in your browser). 
